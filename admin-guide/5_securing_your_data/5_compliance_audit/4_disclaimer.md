---
slug: ent-adding-terms-of-service
title: '[Ent] Adding Terms of Service'
description: Adding a custom disclaimer and/or EULA that must be accepted by the user before she can access the system for the first time.
menu: '[Ent] Adding Terms of Service'
language: und
weight: 4
...
![](../../images/5_securing_your_data/auditing_accesses/disclaimer/disclaimer_enable.png)
...
![](../../images/5_securing_your_data/auditing_accesses/disclaimer/disclaimer_settings.png)
...
![](../../images/5_securing_your_data/auditing_accesses/disclaimer/disclaimer_user_login.png)