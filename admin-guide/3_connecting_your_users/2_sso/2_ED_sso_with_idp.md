...
- [Google authentication with Cells](https://docs.pydio.com/en/docs/kb/identity-management/using-google-identity-provider) (OIDC)
- [Github authentication with Cells](https://docs.pydio.com/en/docs/kb/identity-management/using-github-identity-provider) (OIDC)
- [Azure ADFS](https://docs.pydio.com/en/docs/kb/identity-management/using-azure-adfs-identity-provider)
- [ADFS on-premise server](https://docs.pydio.com/en/docs/kb/identity-management/using-premise-adfs-server-identity-provider)
- [SimpleSAML](https://docs.pydio.com/en/docs/kb/identity-management/using-simplesaml-php-server-identity-provider) PHP server (SAML)
