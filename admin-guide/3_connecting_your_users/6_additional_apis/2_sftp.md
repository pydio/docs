---
slug: ent-sftp-access
title: '[Ent] SFTP Access'
description: Enabling and configuring  the Pydio Cells internal gateway to use the SFTP protocol to communicate with your Pydio Cells server.
menu: '[Ent] SFTP Access'
language: und
weight: 2
