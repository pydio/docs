...
Install and start Pydio Cells as usual on the target machine. Please [visit our documentation for more information](/cells-v4/admin-guide/quick-start/cells-installation/index/).
