...
Install and start Pydio Cells as usual on the target machine. Please [visit our documentation for more information](https://docs.pydio.com/cells-v4/admin-guide/quick-start/cells-installation/index/).
...
![](../images/7_miscellaneous/migration/migrateworkspace.png)
...
![](../images/7_miscellaneous/migration/workspacemapping.png)
