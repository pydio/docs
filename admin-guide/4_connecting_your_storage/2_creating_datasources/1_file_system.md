...
- Due to the internal implementation of the file-system-based Object service (see [previous chapter](/cells-v4/admin-guide/connect-your-storage/datasources-overview/)):
