---
slug: tuning-server-performances
title: "Tuning server performances"
language: und
menu: "Tuning server performances"
weight: 5
...
![](../images/6_pydio_advanced_configuration/cache_service_configuration_update.png)
