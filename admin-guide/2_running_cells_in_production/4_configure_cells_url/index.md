Cells acts an autonomous web server via the [Cells Gateway](/cells-v4/admin-guide/quick-start/glossary). Similarly to Apache, Ngninx or Caddy, Cells provides
