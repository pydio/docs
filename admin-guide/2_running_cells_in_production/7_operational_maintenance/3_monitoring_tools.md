...
Please refer to the knowledge base for [more information about the Prometheus/Grafana](https://docs.pydio.com/en/docs/kb/deployment/monitoring-cells-prometheus-grafana) configuration.